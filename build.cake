...
var sln = new FilePath("ExoPlayer.sln");
	...
	.Does(() => 
{
	...
	GitLink("./", 
		new GitLinkSettings {
			RepositoryUrl = "https://github.com/martijn00/ExoPlayerXamarin",
			Configuration = "Release",
			SolutionFileName = "ExoPlayer.sln",
	...
	.Does(() => 
{
	var nugetSettings = new NuGetPackSettings {
		Authors = new [] { "Martijn van Dijk" },
		Owners = new [] { "Martijn van Dijk" },
		IconUrl = new Uri("https://raw.githubusercontent.com/martijn00/ExoPlayerXamarin/master/icon_exoplayer.png"),
		ProjectUrl = new Uri("https://github.com/martijn00/ExoPlayerXamarin"),
		LicenseUrl = new Uri("https://github.com/martijn00/ExoPlayerXamarin/blob/master/LICENSE.md"),
		Copyright = "Copyright (c) Martijn van Dijk",
	...
	var nuspecs = new List<string> {
        ...
        "ExoPlayer.Ext.Gvr",
        "ExoPlayer.Ext.Ima",
        "ExoPlayer.Ext.MediaSession",
        "ExoPlayer.Ext.OkHttp",
        "ExoPlayer.Ext.Rtmp",
        "ExoPlayer.Hls",
...
Task("PublishPackages")
    ...
    .WithCriteria(() => IsRepository("martijn00/ExoPlayerXamarin"))
    .WithCriteria(() => 
		StringComparer.OrdinalIgnoreCase.Equals(versionInfo.BranchName, "develop") || 
		IsMasterOrReleases())
    .Does (() =>
