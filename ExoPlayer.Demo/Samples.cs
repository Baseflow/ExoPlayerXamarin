 ...
 */
    internal class Samples
    {
        public class Sample : Object
        {
            ...
            public Sample(string name, string uri, int type) : this(name, name.ToLower().Replace(" ", ""), uri, type)
            {
            }
        ...
        public static readonly Sample[] YOUTUBE_DASH_MP4 = new Sample[]
        {
        ...
        public static readonly Sample[] YOUTUBE_DASH_WEBM = new Sample[]
        {
            new Sample("Google Glass",
                "http://www.youtube.com/api/manifest/dash/id/bf5bb2419360daf1/source/youtube?"
        ...
        public static readonly Sample[] SMOOTHSTREAMING = new Sample[]
        {
        ...
        public static readonly Sample[] WIDEVINE_GTS = new Sample[]
        {
        ...
        public static readonly Sample[] HLS = new Sample[]
        {
        ...
        public static readonly Sample[] MISC = new Sample[]
        {
